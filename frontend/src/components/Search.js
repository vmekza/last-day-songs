...
const popularSongsData = [
  {
    ...
    album: {
      images: [
        {
          url: 'https://i.scdn.co/image/ab67616d0000b2735b646e3a50ea4f0e4c5b5aa3',
        },
      ],
    },
    preview_url:
      'https://p.scdn.co/mp3-preview/1e27849d9e8481b68bad224955f6cf964afd70d0?cid=6c69e88cb3d6418b985f5dd5c7801b3f',
  },
  {
    id: '2',
    name: 'David Bowie',
    ...
    album: {
      images: [
        {
          url: 'https://i.scdn.co/image/ab67616d0000b273a47e80463147d1877608d56b',
        },
      ],
    },
    preview_url:
      'https://p.scdn.co/mp3-preview/e573641a3b4e3b126d37c2b4573e197dcac2f354?cid=6c69e88cb3d6418b985f5dd5c7801b3f',
  },
  {
    id: '3',
    name: 'Linkin Park',
    ...
    preview_url:
      'https://p.scdn.co/mp3-preview/b5ee275ca337899f762b1c1883c11e24a04075b0?cid=6c69e88cb3d6418b985f5dd5c7801b3f',
  },
  {
    id: '4',
    name: 'Lou Reed',
    ...
    preview_url:
      'https://p.scdn.co/mp3-preview/84d43797277b787143eb09575da79623a2141efa?cid=6c69e88cb3d6418b985f5dd5c7801b3f',
  },
  {
    id: '5',
    name: 'Hans Zimmer',
    ...
    preview_url:
      'https://p.scdn.co/mp3-preview/6633d359c78b728568527226197ed891a652efff?cid=6c69e88cb3d6418b985f5dd5c7801b3f',
  },
];
...
const Search = () => {
  ...
  useEffect(() => {
    ...
    if (savedPlaylist) {
      ...
      const loadedAddedTracks = JSON.parse(savedPlaylist).reduce(
        (acc, track) => {
          acc[track.id] = true;
          return acc;
        },
  ...
  async function search() {
    var searchURL = `https://api.spotify.com/v1/search?q=${encodeURIComponent(
      searchInput
    )}&type=track,artist&limit=50`;
    ...
    <div className='songs'>
      <div className='songs_search search'>
        <div className='search_wrapper'>
          <div className='search_item'>
            ...
            />
            <button onClick={search} className='search_button button'>
              Search
            </button>
          </div>
          <div
            className='search_playlist playlist'
              ...
              <div className='playlist_dropdown'>
                  ...
                  playlist.map((track, index) => (
                    <div key={index} className='playlist_track'>
                      ...
                      <div className='playlist_wrapper'>
                        <div className='playlist_track_artist'>
                ...
                {playlist.length > 0 && (
                  <button
                    ...
                    className='playlist_button-customize button'
                  >
                    Customize
                  </button>
                )}
      ...
      <div className='search_results result'>
        {searchResults.length === 0 && (
          <div className='result_title-popular'>Popular Tracks</div>
        )}
          ...
          {searchResults.length > 0
            ? searchResults.map((track) => (
                <div className='result_card' key={track.id}>
                  ...
                  <div
                    className='result_play_icon'
                    style={{ opacity: track.preview_url ? 1 : 0.2 }}
                    onClick={() =>
                      track.preview_url &&
                      playTrack(track.preview_url, track.id)
                    }
                  >
